...
exports.getProductsBySeller = async (req, res) => {
  try {
    const { username } = req.params; // Extract sellerId from the URL parameters

    // Fetch products for the specified sellerId
    ...
    res.status(200).json(productsWithImageURL); // Respond with the formatted products
  } catch (error) {
